...
client.open("GET", "/sidebar.frag");
client.onreadystatechange = function(){
    document.getElementById("sidebar").innerHTML = client.responseText;
}
...
function viewAllEvents()
{
  ...
  alert("query requested")
  viewClient.open("GET", "/viewAllEvents");
  ...
  {
    alert("query results")
    document.getElementById("ViewAllEvents").innerHTML = viewClient.responseText;
  }
  viewClient.send();
}


// Makes the side bar interactive
...
Calendar.prototype.Calendar = function(y,m) {
  ...
  var may = document.getElementById("monthandyear")
  if(may) may.innerHTML = monthandyearhtml;

  var tdi = document.getElementById(this.divId)
  if(tdi) tdi.innerHTML = html;
};
...
window.onload = function() {
  ...
  if(c && getId('btnPrev') && getId('btnPrevYr') && getId('btnNext') && getId('btnNextYr')){
  c.showCurrent();
